...
<div class="sticky">
  <div id="txtitle" style="background-color:#0b1116; padding: 4px;" >
	...
	<ul class="nav nav-tabs nav-justified" id="myTab" style="border-bottom:0px">
			  <li  ><a href="market.php"><span class="glyphicon glyphicon glyphicon glyphicon-stats carty" aria-hidden="true"></span> Market</i></a></li>
			  <li><a href="news.php"><span class="glyphicon glyphicon glyphicon-globe carty" aria-hidden="true"></span> News</a></li>
...
<div class="jumbotron main-jumbotron" >
    ...
    <section>
      <div id="txtcolor" class="container">
       ...
       <p class="lead">StockTrackr.com allows users to create their own stocks portfolio without creating an account. The data is stored via local storage and can be accessed only by the user. Users may view our Stock website on both mobile and desktop browsers.</p> 
      ...
      <h4><p>Created as a Project by Aviral, Viraj, Hiten, Yuvraj, Harsh for Sem 4</p></h4>
        ...
        <div class="row">
          <div class="col-sm-4">
            <div class="post" >
              ...
              <h3 ><a href="" style="color: #f1cb05 !important;">StockTrackr</a></h3>
              <p class="post__intro" style="color: white !important;">View other apps by our publisher here, including StockTrackr's app</p>
...
<p>Copyright © 2023. StockTrackr. | Project SEM 4</p>
</section>
</footer>
