...
<div class="sticky">
  <div id="txtitle" style="background-color:#0b1116; padding: 4px;" >
	...
	<ul class="nav nav-tabs nav-justified" id="myTab" style="border-bottom:0px">
			  ...
			  <li><a href="about.php"><span class="glyphicon glyphicon glyphicon glyphicon-question-sign carty" aria-hidden="true"></span> About</a></li>
			</ul>
...
<div id="outtertable" class="table-responsive thistablu">
	<table id="customers" class="js-sort-table table tabulart borderless table-hover table-condensed">
		...
		foreach ($data['data'] as $value) {
			...
			echo "<a href=\"coininfo.php?id=" .  $value["quote"]["symbol"] . "\">";
			echo $name . " (" . $symbol . ")";
			echo "</a>";
			echo "</td>";
...
<p>Copyright © 2018. StockTrackr. | Project SEM 4</p>
</section>
</footer>
